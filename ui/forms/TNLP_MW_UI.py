...
try:
    _fromUtf8 = QtCore.QString.Latin1
...
class Ui_ToNgueLP_MW(object):
    def setupUi(self, ToNgueLP_MW):
        ...
        self.actionEdit_Case.setEnabled(False)
        icon6 = QtGui.QIcon()
        ...
        self.actionEdit_annotation.setEnabled(False)
    ...
    def retranslateUi(self, ToNgueLP_MW):
        ToNgueLP_MW.setWindowTitle(QtGui.QApplication.translate("ToNgueLP_MW", "ToNgueLP", None, QtGui.QApplication.CodecForTr))
        self.menuCorpus.setTitle(QtGui.QApplication.translate("ToNgueLP_MW", "Corpus", None, QtGui.QApplication.CodecForTr))
        self.menuTools.setTitle(QtGui.QApplication.translate("ToNgueLP_MW", "Tools", None, QtGui.QApplication.CodecForTr))
        self.menuConfig.setTitle(QtGui.QApplication.translate("ToNgueLP_MW", "Config", None, QtGui.QApplication.CodecForTr))
        self.menuScripts.setTitle(QtGui.QApplication.translate("ToNgueLP_MW", "Scripts", None, QtGui.QApplication.CodecForTr))
        self.menuHelp.setTitle(QtGui.QApplication.translate("ToNgueLP_MW", "Help", None, QtGui.QApplication.CodecForTr))
        self.menuLogin.setTitle(QtGui.QApplication.translate("ToNgueLP_MW", "Login", None, QtGui.QApplication.CodecForTr))
        self.menuCases.setTitle(QtGui.QApplication.translate("ToNgueLP_MW", "Cases", None, QtGui.QApplication.CodecForTr))
        self.menuAnnotations.setTitle(QtGui.QApplication.translate("ToNgueLP_MW", "Annotations", None, QtGui.QApplication.CodecForTr))
        self.toolBar_Main.setWindowTitle(QtGui.QApplication.translate("ToNgueLP_MW", "toolBar", None, QtGui.QApplication.CodecForTr))
        self.toolBar_Fixed.setWindowTitle(QtGui.QApplication.translate("ToNgueLP_MW", "toolBar_2", None, QtGui.QApplication.CodecForTr))
        self.toolBar_Cases.setWindowTitle(QtGui.QApplication.translate("ToNgueLP_MW", "toolBar_3", None, QtGui.QApplication.CodecForTr))
        self.actionLoad_New_Corpus.setText(QtGui.QApplication.translate("ToNgueLP_MW", "Load Corpus", None, QtGui.QApplication.CodecForTr))
        self.actionAdd_New_Corpus_Doc.setText(QtGui.QApplication.translate("ToNgueLP_MW", "Add New Corpus Doc", None, QtGui.QApplication.CodecForTr))
        self.actionCorpus_Information.setText(QtGui.QApplication.translate("ToNgueLP_MW", "Corpus Information", None, QtGui.QApplication.CodecForTr))
        self.actionClose_Corpus.setText(QtGui.QApplication.translate("ToNgueLP_MW", "Close Corpus", None, QtGui.QApplication.CodecForTr))
        self.actionAdd_Algorithm_Output.setText(QtGui.QApplication.translate("ToNgueLP_MW", "Add Algorithm Output", None, QtGui.QApplication.CodecForTr))
        self.actionAdd_New_Case.setText(QtGui.QApplication.translate("ToNgueLP_MW", "Add Case", None, QtGui.QApplication.CodecForTr))
        self.actionEdit_Case.setText(QtGui.QApplication.translate("ToNgueLP_MW", "Edit Case", None, QtGui.QApplication.CodecForTr))
        self.actionValidate_Case.setText(QtGui.QApplication.translate("ToNgueLP_MW", "Validate Case", None, QtGui.QApplication.CodecForTr))
        self.action_Re_Define_Boundaries.setText(QtGui.QApplication.translate("ToNgueLP_MW", "(Re)Define Boundaries", None, QtGui.QApplication.CodecForTr))
        self.actionView_Annotation.setText(QtGui.QApplication.translate("ToNgueLP_MW", "View Annotation", None, QtGui.QApplication.CodecForTr))
        self.actionSave_Corpus.setText(QtGui.QApplication.translate("ToNgueLP_MW", "Save Corpus", None, QtGui.QApplication.CodecForTr))
        self.actionSelect_Parser.setText(QtGui.QApplication.translate("ToNgueLP_MW", "Select Parser", None, QtGui.QApplication.CodecForTr))
        self.actionSuggest_Parser.setText(QtGui.QApplication.translate("ToNgueLP_MW", "Suggest Parser", None, QtGui.QApplication.CodecForTr))
        self.actionMain_View.setText(QtGui.QApplication.translate("ToNgueLP_MW", "Main View", None, QtGui.QApplication.CodecForTr))
        self.actionComparison_View.setText(QtGui.QApplication.translate("ToNgueLP_MW", "Comparison View", None, QtGui.QApplication.CodecForTr))
        self.actionDictionary_View.setText(QtGui.QApplication.translate("ToNgueLP_MW", "Dictionary View", None, QtGui.QApplication.CodecForTr))
        self.actionConvert_Documents.setText(QtGui.QApplication.translate("ToNgueLP_MW", "Convert Documents", None, QtGui.QApplication.CodecForTr))
        self.actionVerify_Corpus_and_Parser.setText(QtGui.QApplication.translate("ToNgueLP_MW", "Verify Corpus and Parser", None, QtGui.QApplication.CodecForTr))
        self.actionGenerate_Output.setText(QtGui.QApplication.translate("ToNgueLP_MW", "Generate Output", None, QtGui.QApplication.CodecForTr))
        self.actionCompare_Parser_Output_and_XML_Output.setText(QtGui.QApplication.translate("ToNgueLP_MW", "Compare Parser Output and XML Output", None, QtGui.QApplication.CodecForTr))
        self.actionGenerate_XML_Output.setText(QtGui.QApplication.translate("ToNgueLP_MW", "Generate XML Output", None, QtGui.QApplication.CodecForTr))
        self.actionCompare_Parser_and_XML_Output.setText(QtGui.QApplication.translate("ToNgueLP_MW", "Compare Parser and XML Output", None, QtGui.QApplication.CodecForTr))
        self.actionCompare_XMLs.setText(QtGui.QApplication.translate("ToNgueLP_MW", "Compare XMLs", None, QtGui.QApplication.CodecForTr))
        self.actionUpdate_XMLs_Info.setText(QtGui.QApplication.translate("ToNgueLP_MW", "Update XMLs Info", None, QtGui.QApplication.CodecForTr))
        self.actionAbout_ToNgueLP.setText(QtGui.QApplication.translate("ToNgueLP_MW", "About ToNgueLP", None, QtGui.QApplication.CodecForTr))
        self.actionHelp.setText(QtGui.QApplication.translate("ToNgueLP_MW", "Help", None, QtGui.QApplication.CodecForTr))
        self.actionUser_s_Manual.setText(QtGui.QApplication.translate("ToNgueLP_MW", "User\'s Manual", None, QtGui.QApplication.CodecForTr))
        self.actionExit.setText(QtGui.QApplication.translate("ToNgueLP_MW", "Exit", None, QtGui.QApplication.CodecForTr))
        self.actionExit.setShortcut(QtGui.QApplication.translate("ToNgueLP_MW", "Ctrl+Q", None, QtGui.QApplication.CodecForTr))
        self.actionAdd_case.setText(QtGui.QApplication.translate("ToNgueLP_MW", "Add case", None, QtGui.QApplication.CodecForTr))
        self.actionDelete_case.setText(QtGui.QApplication.translate("ToNgueLP_MW", "Delete case", None, QtGui.QApplication.CodecForTr))
        self.actionAdd_annotation.setText(QtGui.QApplication.translate("ToNgueLP_MW", "Add Annotation", None, QtGui.QApplication.CodecForTr))
        self.actionEdit_annotation.setText(QtGui.QApplication.translate("ToNgueLP_MW", "Edit annotation", None, QtGui.QApplication.CodecForTr))
        self.actionDelete_annotation.setText(QtGui.QApplication.translate("ToNgueLP_MW", "Delete annotation", None, QtGui.QApplication.CodecForTr))
        self.actionCreate_Corpus.setText(QtGui.QApplication.translate("ToNgueLP_MW", "Create Corpus", None, QtGui.QApplication.CodecForTr))
