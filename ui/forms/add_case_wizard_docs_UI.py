...
#
# Created: Fri Sep 18 21:26:35 2015
...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.chk_new_susp = QtGui.QCheckBox(Dialog)
        self.chk_new_susp.setObjectName(_fromUtf8("chk_new_susp"))
        self.horizontalLayout.addWidget(self.chk_new_susp)
        ...
        self.cb_susp_doc_topic = QtGui.QComboBox(Dialog)
        self.cb_susp_doc_topic.setObjectName(_fromUtf8("cb_susp_doc_topic"))
        self.horizontalLayout.addWidget(self.cb_susp_doc_topic)
        ...
        self.lb_susp_words_count = QtGui.QLabel(Dialog)
        self.lb_susp_words_count.setObjectName(_fromUtf8("lb_susp_words_count"))
        self.horizontalLayout_2.addWidget(self.lb_susp_words_count)
        spacerItem2 = QtGui.QSpacerItem(40, 20, QtGui.QSizePolicy.Expanding, QtGui.QSizePolicy.Minimum)
        self.horizontalLayout_2.addItem(spacerItem2)
        self.gridLayout.addLayout(self.horizontalLayout_2, 1, 0, 1, 1)
        self.te_susp_text = QtGui.QTextEdit(Dialog)
        self.te_susp_text.setReadOnly(False)
        ...
        self.cb_src_doc_topic = QtGui.QComboBox(Dialog)
        self.cb_src_doc_topic.setObjectName(_fromUtf8("cb_src_doc_topic"))
        self.horizontalLayout_4.addWidget(self.cb_src_doc_topic)
        ...
        self.horizontalLayout_3.addWidget(self.lb_src_words_count)
        ...
        QtCore.QObject.connect(self.chk_new_susp, QtCore.SIGNAL(_fromUtf8("clicked(bool)")), self.btn_select_susp_doc.setDisabled)
        QtCore.QObject.connect(self.chk_new_susp, QtCore.SIGNAL(_fromUtf8("clicked(bool)")), self.label_9.setDisabled)
        QtCore.QObject.connect(self.chk_new_susp, QtCore.SIGNAL(_fromUtf8("clicked(bool)")), self.lb_susp_doc_name.setDisabled)
        QtCore.QMetaObject.connectSlotsByName(Dialog)

    def retranslateUi(self, Dialog):
        Dialog.setWindowTitle(_translate("Dialog", "Dialog", None))
        self.chk_new_susp.setText(_translate("Dialog", "New susp doc", None))
        ...
        self.label.setText(_translate("Dialog", "Topic:", None))
        ...
        self.lb_susp_words_count.setText(_translate("Dialog", "0", None))
        self.btn_select_src_doc.setText(_translate("Dialog", "Select src doc", None))
        self.label_14.setText(_translate("Dialog", "Doc name:", None))
        self.lb_src_doc_name.setText(_translate("Dialog", "src/", None))
        self.label_2.setText(_translate("Dialog", "Topic:", None))
        self.label_15.setText(_translate("Dialog", "Offset:", None))
        self.lb_src_offset.setText(_translate("Dialog", "0", None))
        self.label_16.setText(_translate("Dialog", "Length:", None))
        self.lb_src_length.setText(_translate("Dialog", "0", None))
        self.label_17.setText(_translate("Dialog", "Sentences:", None))
        self.lb_src_sentences_count.setText(_translate("Dialog", "0", None))
        self.label_18.setText(_translate("Dialog", "Words:", None))
